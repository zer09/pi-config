...
Report: changed paths; implementation summary; exact checks and results; remaining risks.`,
  ...
  implementation: `Implement only the assigned increment; preserve user-owned changes and stated invariants.
