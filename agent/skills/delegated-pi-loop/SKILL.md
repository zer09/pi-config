...
| ---------------------------------------- | ----------------------------------------------------------------------------------- | --------------: | ------------------------- |
| Independent solution investigation A     | SeekAI Claude Opus 5                                                                |          `high` | Prohibited                |
...
| Small-task implementation or remediation | SeekAI Claude Opus 4.8 → AgentRouter Opus 4.8 → SeekAI DeepSeek V4 Flash → Luna     |         `xhigh` | Narrowly allowed          |
| Independent implementation review A      | SeekAI Claude Fable 5                                                               |          `high` | Prohibited                |
...
3. Launch two direct bash calls in one parallel tool batch: SeekAI Claude Opus 5/high and the AgentRouter Opus 5/high → AgentRouter GPT-5.6 Sol/high chain. Preserve separate artifacts and do not show either investigator the other report. When the user or project assigns Z.AI or Claude Code to an investigator role, preserve the same read-only contract and required two-investigator gate.
