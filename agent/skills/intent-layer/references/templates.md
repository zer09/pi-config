...
Each subdirectory `AGENTS.md`:

```markdown
# {Area Name}

## Purpose
[1-2 sentences: what this area owns and what it explicitly does not do]
...
- <20k tokens: no node usually needed.
- 20-64k tokens: good candidate for a 2-3k token node.
