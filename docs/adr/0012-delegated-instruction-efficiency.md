...
The supervisor remains the only wall-clock authority. It uses monotonic time for the five-minute activity warning, ten-minute activity-idle termination, and, since ADR 0015, a renewable 45-minute structural-progress lease instead of a total productive-work deadline. This change does not alter the supervisor's time semantics; the lease replacement is governed by ADR 0015.
