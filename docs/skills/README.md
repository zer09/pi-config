...
- `delegated-pi-loop-update-process.md`: update workflow for the custom bounded, fresh-session multi-provider Pi and Claude Code implementation, verification, remediation, and independent-review orchestrator.
