...
- `delegated-pi-loop-update-process.md`: update workflow for the custom fresh-session implementation, verification, remediation, and independent-review orchestrator.
