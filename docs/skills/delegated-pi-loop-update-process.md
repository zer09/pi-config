...
- Source of truth: this Pi config, ADR 0007 through ADR 0013, and installed Pi RPC/extension documentation.
...
2. Read ADR 0007 through ADR 0013, this document, and every owned source file.
