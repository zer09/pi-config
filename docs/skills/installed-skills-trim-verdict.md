...
| ✓ | delegated-pi-loop | Weak | 3 | keep it | Installed as a compact custom workflow for fresh Pi or explicitly selected Claude Opus 5 CLI roles, separate finding verification/remediation, reviewer neutrality, and single-mutator shared-tree safety. |
