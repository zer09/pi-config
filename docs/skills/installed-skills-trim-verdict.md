...
| ✓ | delegated-pi-loop | Weak | 3 | keep it | Installed as a compact custom workflow for default Pi roles or explicitly selected Z.AI GLM 5.3/max and Claude Opus 5/medium alternatives, separate finding verification/remediation, reviewer neutrality, and single-mutator shared-tree safety. |
